...
const Card = ({clg}) => {
 const {_id,collegeImage, collegeName, admissionDates, rating, researchWorks}=clg;
 return (
  ...
  <div className="card-body">
    ...
    <p className="text-xl"><span className=" font-semibold">Research: </span> {researchWorks.length}</p>
